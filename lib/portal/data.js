// Handler de /api/portal/data. Vive en lib/ (NO en api/) para no contar como
// Vercel function: la function real es api/portal/[kind].js, que despacha acá
// (mismo patrón que lib/web/handlers.js ↔ api/public/[kind].js).
//
